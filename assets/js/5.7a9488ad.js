(window.webpackJsonp = window.webpackJsonp || []).push([
  [5],
  {
    ...
    337: function (e, t, n) {
      "use strict";
      n.r(t);
      n(166), n(310), n(167), n(92), n(325), n(91);
      var a = n(42),
        r = n(313),
        o = n(308),
        s = {
          ...
          mounted: function () {
            (this.tokenType = this.getParam("tokenType") || "Standard"),
              (this.currentNetwork =
          ...
          methods: {
                      ...
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              (e.network.current =
                                e.network.list[e.currentNetwork]),
                              (t.prev = 1),
                              (t.next = 4),
                              e.initWeb3(e.currentNetwork, !0)
                            );
                          case 4:
                            return (
                              e.initService(e.currentNetwork),
                              (t.next = 7),
                              e.loadToken()
                            );
                          case 7:
                        ...
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              Object.prototype.hasOwnProperty.call(
                                ...
                                (e.tokenType = "Standard")),
                              e.initToken(e.tokenType),
                              e.updateTokenDetails(),
                              e.updateSupply(),
                              e.updateCap(),
                              (t.prev = 5),
                              (t.next = 8),
                              e.promisify(
                                e.contracts.service.methods.getPrice(
                                  e.tokenType
                                ).call
                              )
                            );
                          ...
                          case 11:
                            (t.prev = 11),
                              ...
                              "mainnet" === e.currentNetwork
                                ? (e.makeToast(
                                    "Warning",
                                    "We are having an issue with Current Network Provider. Please switch Network or try again later.",
                                    "warning"
                                  ),
                                  (e.feeAmount = e.web3.utils.toWei(
                                    "0",
                                    "ether"
                                  )))
                                : (e.feeAmount = e.web3.utils.toWei(
                                    "".concat(e.token.price),
                                    "ether"
                                  ));
                          case 15:
                            "mainnet" === e.currentNetwork &&
                              (e.gaSend("ViewContent", e.tokenType, ""),
                              e.fbtrack("ViewContent", {
                                content_ids: [e.tokenType],
                                          ...
                                          switch ((t.prev = t.next)) {
                                            ...
                                            case 6:
                                              ...
                                              return (
                                                e.makeToast(
                                                  "Warning",
                                                  "Your MetaMask in on the wrong network. Please switch on ".concat(
                                                    e.network.current.name,
                                                    " and try again!"
                                                  ),
                                                  "warning"
                                                ),
                                            ...
                                            case 9:
                                              return (
                                                ...
                                                (t.next = 17),
                                                e.web3Provider.request({
                                                  method: "eth_requestAccounts",
                                                })
                                              );
                                            case 17:
                                              return (
                                                (a = new e.web3.eth.Contract(
                                                  e.contracts.token.abi
                                                )),
                                                (r = {
                                                  data: e.contracts.token
                                                    .bytecode,
                                                  arguments:
            ...
            updateTokenDetails: function () {
              ...
              (this.token.customizeDecimals = t.customizeDecimals),
                (this.token.verified = t.verified),
                (this.token.supplyType = t.supplyType),
                (this.token.accessType = t.accessType),
                (this.token.mintable = t.mintable),
                (this.token.burnable = t.burnable),
                (this.token.operable = t.operable),
                (this.token.tokenRecover = t.tokenRecover),
                (this.token.removeCopyright = t.removeCopyright),
                (this.token.price = t.price),
                (this.token.gas = this.web3.utils.toBN(t.gas)),
                (this.token.decimals = t.customizeDecimals
                  ? this.token.decimals
                  : 18);
            },
            updateCap: function () {
            ...
            getDeployArguments: function () {
              var e = this.token.name,
                t = this.token.symbol,
                n = this.web3.utils.toBN(this.token.decimals),
                a = this.web3.utils
                  .toBN(this.token.cap)
            ...
            estimateDeployGas: function (e, t, n) {
              var r = this;
              return Object(a.a)(
                        ...
                        switch ((a.prev = a.next)) {
                          case 0:
                            return (
                              (a.prev = 0),
                              (a.next = 3),
                              r.promisify(e.deploy(t).estimateGas, n)
                            );
                          case 3:
                            return (
                              (o = a.sent),
                              a.abrupt("return", r.web3.utils.toBN(o).muln(1.3))
                            );
                          case 7:
                            return (
                              (a.prev = 7),
                              ...
                              e.web3Provider.request({
                                ...
                                params: {
                                  ...
                                  options: {
                                    ...
                                    symbol: e.token.symbol.substr(0, 5),
            ...
            return n(
              ...
              [
                n("b-jumbotron", {
                  ...
                  attrs: {
                    "text-variant": "white",
                    header: "Kazifier - Create your CRO Token",
                    fluid: "",
                  },
                  scopedSlots: e._u([
                    {
                      ...
                      fn: function () {
                        return [
                          e._v(
                            "\n            Easily deploy Smart Contract for a Standard, Capped, Mintable, Burnable CRO Token.\n            "
                          ),
                          n("br"),
                          e._v(
                                                      ...
                                                      [
                                                        ...
                                                        n(
                                                          "b-form-group",
                                                          {
                                                            attrs: {
                                                              description:
                                                                "Recover anyCRO token sent into the contract for error.",
                                                            },
                                                          },
                                                          [
                                                            n(
                                                                          ...
                                                                          [
                                                                            {
                                                                              ...
                                                                              value:
                                                                                "Commission will be transferred directly to us through the BSC network as part of your payment. Commission will support CRO Token Generator to keep it safe, running and constantly updated.",
                                                                              expression:
                                                                                "\n                                                    'Commission will be transferred directly to us through the ' +\n                                                    'BSC network as part of your payment. ' +\n                                                    'Commission will supportCRO Token Generator to keep it ' +\n                                                    'safe, running and constantly updated.'",
                                                                              modifiers:
                                                                                {
                                                                                  "v-warning":
                                                                                    !0,
